...
const typedTableData = TableData as unknown as Payment[]
  return (
    <div className="w-full min-h-screen flex flex-col bg-gray-50  bg-white dark:bg-zinc-800">
      <div className="w-full  flex flex-col gap-8 lg:pl-[1rem] lg:pr-2 py-8">
      ...
      {CardData.map((card, index) => (
        ...
        <div className="flex flex-col lg:flex-row gap-4 mt-4 w-full">
          ...
          <div className="flex-[0_0_41%] min-w-0 flex flex-col bg-white dark:bg-zinc-800">
